...
import com.ide.photoeditor.youshoot.cutomView.MarkerView;
import com.ide.photoeditor.youshoot.cutomView.WaveformView;
import com.ide.photoeditor.youshoot.cutomView.soundfile.CheapSoundFile;
import com.ide.photoeditor.youshoot.utils.SeekTest;
import com.ide.photoeditor.youshoot.utils.SongMetadataReader;
...
public class SongEditActivity extends AppCompatActivity implements MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    public class MusicAdapter extends Adapter<MusicAdapter.Holder> {
        ...
        public Holder onCreateViewHolder(ViewGroup parent, int paramInt) {
            return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.items_music_list, parent, false));
        }
    ...
    public void onCreate(Bundle icicle) {
        ...
        loadGui();
        init();
        AdUtils.showNativeAd(SongEditActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
    ...
    private void loadGui() {
        setContentView((int) R.layout.activity_song_edit);
        ...
        MaterialButton mMbtnSave=findViewById(R.id.mMbtnSave);
        MaterialButton mMbtnBack=findViewById(R.id.mMbtnBack);

        mMbtnSave.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onSave();
                MyApp.getInstance().setMusicData(selectedMusicData);
            }
        });
        mMbtnBack.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
    ...
    private void afterSavingRingtone(CharSequence title, String outPath, File outFile, int duration) {
        ...
        MyApp.getInstance().setMusicData(this.selectedMusicData);
        finish();
    }
