...
//    private FreshDownloadView freshDownloadView1;
    ...
    private TextView mTxtMsg,mTxtMsg1;
...
//        this.circularProgress = (CircularFillableLoaders) findViewById(R.id.circularProgress);
        this.mTxtMsg = (TextView) findViewById(R.id.mTxtMsg);
        this.mTxtMsg1 = (TextView) findViewById(R.id.mTxtMsg1);
...
//        this.tvMsg = (TextView) findViewById(R.id.tvMsg);
   ...
   /* protected void onStop() {
        ...
        if (MyApp.isMyServiceRunning(this, CreateVideoService.class)) {
            finish();
        }
    }*/
...
//        if (this.circularProgress != null) {
            runOnUiThread(new Runnable() {
                public void run() {
                    mTxtMsg1.setText("==="+(int) (25.0f + ((75.0f * progress) / 100.0f)));
...
//        }
    ...
    private void loadVideoPlay() {
        Toast.makeText(application, "Savedddd....", Toast.LENGTH_SHORT).show();
        finish();
